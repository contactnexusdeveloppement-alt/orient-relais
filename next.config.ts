  ...
  headers: async () => [
    {
      ...
      headers: [
        ...
        { key: 'X-DNS-Prefetch-Control', value: 'on' },
        {
          ...
          value: [
            "default-src 'self'",
            "script-src 'self' 'unsafe-inline' https://js.stripe.com https://widget.mondialrelay.com https://www.googletagmanager.com https://www.google-analytics.com https://code.jquery.com https://unpkg.com",
